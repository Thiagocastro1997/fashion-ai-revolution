    ...
    <div className="slide-container bg-gradient-to-br from-black via-charcoal to-gray-900 text-white relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center px-8">
        ...
        <div className="mb-8 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          ...
          <h2 className="text-6xl lg:text-7xl font-light text-gold mb-6">
            para Moda
          </h2>
        </div>
        ...
        <div className="mb-16 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
          <p className="text-2xl lg:text-3xl font-light text-silver leading-relaxed max-w-4xl mx-auto">
        ...
        {/* Tech Icons */}
        <div className="absolute bottom-16 left-1/2 transform -translate-x-1/2 flex space-x-12 opacity-60">
          <div className="text-center animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
            <div className="w-12 h-12 bg-white/10 rounded-lg flex items-center justify-center mb-2">
              <span className="text-gold text-lg">AI</span>
            </div>
            <p className="text-xs text-silver">Inteligência Artificial</p>
          </div>
          <div className="text-center animate-fade-in-up" style={{ animationDelay: '1s' }}>
            <div className="w-12 h-12 bg-white/10 rounded-lg flex items-center justify-center mb-2">
              <span className="text-gold text-lg">CRM</span>
            </div>
          ...
          <div className="text-center animate-fade-in-up" style={{ animationDelay: '1.2s' }}>
            <div className="w-12 h-12 bg-white/10 rounded-lg flex items-center justify-center mb-2">
              <span className="text-gold text-lg">ERP</span>
            </div>
